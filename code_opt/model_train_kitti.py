...
def main(args):
    ...
    train_data_path = os.path.join(DATA_DIR, "X_{}.hkl".format(args.train_data_file))
    train_sources_path = os.path.join(DATA_DIR, "sources_{}.hkl".format(args.train_data_file))

    train_dataset = Dataset({"path": train_data_path, "sources": train_sources_path, "unique_mode": False,
    ...
    valid_data_path = os.path.join(DATA_DIR, "X_{}.hkl".format(args.valid_data_file))
    valid_sources_path = os.path.join(DATA_DIR, "sources_{}.hkl".format(args.valid_data_file))

    valid_dataset = Dataset({"path": valid_data_path, "sources": train_sources_path, "unique_mode": True,
...
if __name__ == "__main__":
    ...
    # frame split (1)
    parser.add_argument('--input-frames',  default = 5, type = int,
        help = 'The number of input frames to the model.')
    parser.add_argument('--future-frames', default = 15, type = int,
    ...
    parser.add_argument('--img-channels', default =  2, type = int,
    ...
    parser.add_argument('--dataset', default = "KITTI", type = str,
        help = 'The dataset name. (Options: KTH, MNIST, KITTI)')
    ...
    parser.add_argument('--valid-samples', default = 100, type = int,
    ...
    parser.add_argument('--decay-log-epochs', default = 10, type = int,
